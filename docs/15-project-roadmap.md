...
├── Docker image (ghcr.io/learninghub44/openwa:0.0.1)
├── docker-compose.yml
...
├── Docker image (ghcr.io/learninghub44/openwa:0.0.2)
...
├── Docker image (ghcr.io/learninghub44/openwa:0.1.0)
